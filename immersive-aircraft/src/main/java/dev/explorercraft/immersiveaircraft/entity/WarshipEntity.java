...
import dev.explorercraft.immersiveaircraft.entity.weapon.HeavyCrossbow;
...
public class WarshipEntity extends AirshipEntity {
    ...
    public void positionRider(@NotNull Entity passenger, @NotNull MoveFunction positionUpdater) {
        ...
        if (isTurretGunner(passenger)) {
            ...
            // ponytail: Entity.getMyRidingOffset() removed with the old mount-offset API, see
            // VehicleEntity.positionRider() for the same simplification.
