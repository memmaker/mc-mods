package dev.explorercraft.immersiveaircraft.entity.bullet;
...
public class TinyTNT extends PrimedTnt {
    ...
    public void tick() {
        ...
        if (i <= 0) {
            ...
            // ponytail: Entity.updateInWaterStateAndDoFluidPushing() was removed - move() above
            // already refreshes fluid/water state each tick on its own.
            if (this.level().isClientSide()) {
