...
public class HeavyCrossbow extends BulletWeapon {
    ...
    protected Entity getBullet(Entity shooter, Vector4f position, Vector3f direction) {
        ...
        ItemStack pickupStack = ammoStack != null ? ammoStack : new ItemStack(Items.ARROW);
        Arrow arrow = new Arrow(shooter.level(), position.x(), position.y(), position.z(), pickupStack, ItemStack.EMPTY);
