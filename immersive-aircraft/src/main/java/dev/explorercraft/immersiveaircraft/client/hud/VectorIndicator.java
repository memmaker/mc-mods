...
import static dev.explorercraft.immersiveaircraft.client.hud.Colors.*;
...
public class VectorIndicator implements Indicator {
    ...
    public void drawHUD(GuiGraphicsExtractor context, Minecraft client, int baseX, int baseY, int width, EngineVehicle aircraft, int color, int[] edge) {
        ...
        if (edgeCheck(edge, 5, x0, y0)) {
            dev.explorercraft.immersiveaircraft.client.OverlayRenderer.renderOutline(context, x0 - 3, y0 - 2, 5, 5, color);
    ...
    public void drawDials(GuiGraphicsExtractor context, Minecraft client, int baseX, int baseY, int scale, EngineVehicle aircraft) {
        ...
        if (edgeCheck(edge0, 5, xr, yr)) {
            dev.explorercraft.immersiveaircraft.client.OverlayRenderer.renderOutline(context, xr - 2, yr - 2, 5, 5, colorBG);
